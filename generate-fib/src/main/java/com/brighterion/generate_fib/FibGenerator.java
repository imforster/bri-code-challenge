 ...
 * Utilizes BigInteger to prevent integer rollover for large values of N.
 * @author iforster
 *
 */
public class FibGenerator {
	...
	/**
	 * Recursive fib sequence generator with mem array to prevent repeat calculations
    ...
    /**
     * Recursive function test to see if value has been calculated if so return it otherwise
     * compute value for n.
     * @param n - number in sequence to generate
